...
#+begin_src emacs-lisp :var data=()
  (mapcar (lambda (q) (cons (car q) (cadr q))) data)
#+end_src
...
#+BEGIN_SRC scheme
  ...
  (define-public %packages-by-host
    (alist->hash-table
     `(("dagon" . ,(append shell-utils toolchains multimedia graphics e-mail desktop))
       ("hydra" . ,(append shell-utils toolchains multimedia graphics e-mail desktop)))))
#+END_SRC
...
ssh-rsa  michal_atlas@dagon
#+end_src
